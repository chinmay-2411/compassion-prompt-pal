...
import { Bird, Heart, Bug, Home, Users, Truck, Bike, Clock } from "lucide-react";
...
const services = [
  ...
  { icon: Bug, title: "Small Animal Emergency", desc: "Quick-response rescue service for dogs, cats, and small animals using our innovative bike ambulance for rapid emergency response." },
  ...
  { icon: Truck, title: "Ambulance Services", desc: "Two specialized ambulances: a bike ambulance for small animal emergencies and a large vehicle ambulance for cows and big animals." },
];
