...
import { Bird, Home, Users, Truck, Bike, Clock } from "lucide-react";
...
const services = [
  ...
  { icon: Truck, title: "Ambulance Services", desc: "Bike ambulances for quick bird and small animal rescue emergencies across the city." },
];
    ...
    <div>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container">
          ...
          <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">We operate <strong className="text-foreground">4 bike ambulances</strong> for quick bird and small animal rescue emergencies across the city.</p>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <Card className="border-none bg-card">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">Quick-response bike ambulances for bird and small animal emergencies. Navigate narrow lanes and reach injured animals faster than any vehicle.</p>
                </CardContent>
              </Card>
            </motion.div>
          </div>
